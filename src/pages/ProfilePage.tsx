      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="surface-card gradient-hero p-6 lg:p-8 relative overflow-hidden">
        <div className="flex flex-col md:flex-row gap-6 items-start md:items-center relative z-10">
          ...
          <div className="flex gap-2 w-full md:w-auto shrink-0">
            ...
            <button onClick={onLogout} className="flex-1 md:flex-none inline-flex items-center justify-center gap-1.5 px-4 h-10 rounded-xl bg-destructive/10 text-destructive text-sm font-semibold hover:bg-destructive/20 transition-all cursor-pointer"><LogOut size={14} /> Đăng xuất</button>
          </div>
        </div>
      </motion.div>
