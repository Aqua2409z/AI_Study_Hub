            ...
            >
              <div className="flex items-center justify-between">
                <div
                  ...
                  style={{
                    background: `oklch(0.55 0.14 ${s.color} / 0.12)`,
                ...
                <tr key={q.id} className="hover:bg-muted/30">
                  ...
                  <td className="px-5 py-3 text-right">
                    <div className="inline-flex gap-1">
                      <button className="px-2 h-8 rounded-lg text-xs font-medium bg-success/15 text-success">
                        Duyệt
                      </button>
                      <button className="px-2 h-8 rounded-lg text-xs font-medium bg-destructive/15 text-destructive">
                        Từ chối
                      </button>
                    </div>
                  </td>
